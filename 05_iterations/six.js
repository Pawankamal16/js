...
const values = coding.forEach( (item) => {
    console.log(item);
    return item     // for each func does not return any value, give undefined
} )
...
// filter funct same as for each , it takes callback func() and execute each element and takes a condtion also
